...
/*
Write a query that displays the id, account_id, and total dollar amount for all the orders, sorted
...
/*
Write a query that again displays the id, account_id, and total dollar amount for each order, but this time 
